 ...
 *
 * @param days - The number of days from the start of today.
 * @param hours - The number of hours from the start of today.
 * @param minutes - The number of minutes from the start of today.
 * @return A string representation of the date in ISO 8601 format.
 */
function fromToday(days: number, hours: number, minutes: number): string {
